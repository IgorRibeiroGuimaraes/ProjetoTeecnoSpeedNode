...
exports.findServicoByNome = findServicoByNome;
 ...
 * @returns Retorna os dados do serviço ou `null` se não encontrado.
 */
async function findServicoByNome(servicoNome) {
    return await prisma_1.prisma.servico.findUnique({ where: { nome: servicoNome } });
}
/**
 ...
 */
async function updateCartaServico(cartaId, servicoId) {
